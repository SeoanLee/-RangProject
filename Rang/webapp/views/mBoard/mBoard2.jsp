...
<section class="bg-light page-section" id="mboard">
    <div class="container">
        <div class="row">
            ...
            <br>
                <h2 class="section-heading text-uppercase">MAIN BOARD</h2>
                <h3 class="section-subheading text-muted">  너와 나의 여행이야기 <h3>
            </div>
    ...
    <c:if test="${!empty member}">
        <div class="col" align="right">
            <button id="MOVE_TOP_BTN" type="button" class="btn btn-outline-warning" 
            onclick="location.href='${pageContext.request.contextPath}/views/mBoard/insertMBoard.jsp'">게시글 작성</button>
        </div>
    </c:if>
...
<section>
    ...
    <script>
            ...
            $.ajax({
                ...
                success : function (data) {
                    ...
                    if (data != 0) {
                        ...
                        $('#idid').append('Location : ' + data.mBoard.locationname + "<br>" + 'Cost : ' + data.mBoard.totalcost + ' 원' );
        ...
        function insertComment(){
        	...
        	/* AJAX를 통하여 게시글 번호와 댓글 내용을 전달하고 게시글을 db에 성공적으로 저장하였을 경우
